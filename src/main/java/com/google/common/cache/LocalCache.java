...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
   ...
   */
    ...
    LocalCache(
        ...
        /**
         * 初始化loader 一般重写load()方法
         * new CacheLoader<Long, String>() {
        @Override public String load(Long merchantId) throws Exception {
   ...
   */
     ...
     */
    /**
     * LocalCache 会使用变种Hash算法Wang/Jenkins 对元素的hashCode进行一次再哈希
     */
     ...
     */
       ...
       */
        ...
        ReferenceEntry<K, V> removeValueFromChain(ReferenceEntry<K, V> first,
                                                  ReferenceEntry<K, V> entry, K key, int hash, ValueReference<K, V> valueReference,
                                                  RemovalCause cause) {
