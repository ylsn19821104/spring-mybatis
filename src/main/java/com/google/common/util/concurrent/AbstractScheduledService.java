...
public abstract class AbstractScheduledService implements Service {
   ...
   * the service will transition to the {@link State#FAILED} state and this method will no
   * longer be called.
   */
   ...
   * service {@linkplain State#TERMINATED terminates} or
   * {@linkplain State#TERMINATED fails}. Subclasses may override this method to supply a
   ...
   * service {@linkplain State#TERMINATED terminates} or
   * {@linkplain State#TERMINATED fails}.
   */
