...
public class SqlCostInterceptor implements Interceptor {
        ...
        try {
            if (parameterMappingList != null) {
                ...
                if (isStrictMap(parameterObjectClass)) {
                    ...
                    // 通用场景，比如传的是一个自定义的对象或者八种基本数据类型之一或者
     ...
     * 处理Map场景
     */
    private String handleMapParameter(String sql, Map<?, ?>
            paramMap, List<ParameterMapping> parameterMappingList) {
        for (ParameterMapping parameterMapping : parameterMappingList) {
     ...
     */
    private boolean isPrimitiveOrPrimitiveWrapper
