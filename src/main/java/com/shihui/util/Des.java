 ...
 * 后来针对DES算法进行了改进，有了三重DES算法（也称DESede或Triple-DES）。全名是TDEA：Triple Data
 * Encryption Algorithm
 * DESede针对DES算法的密钥长度较短以及迭代次数偏少问题做了相应改进，提高了安全强度
 * 不过DESede算法处理速度较慢，密钥计算时间较长，加密效率不高
 * <p>1、可以针对properties文件所有属性进行加密</p>
 * <p>2、关于BASE64Encoder加密的使用，亦可以使用apache的base64类</p>
 */
public class Des {
    private Key key; // 密钥
